...
export class AutConfigConstructConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: AutConfigConstructProps) {
    ...
    const crossAccountConfigReadonlyRole = props.crossAccountConfigReadOnlyRole;
    ...
    const autoConfigFunctionDLQ = new sqs.Queue(this, "autoConfigFunctionDLQ", {
    ...
    this.autoConfigFunction = new lambda.Function(
...

      {
        ...
        environment: {
          ...
          RULE_NOTIFICATION_TOPIC_ARN: props.notificationTopic.topicArn,
          LOGLEVEL: loglevel,
          DEFAULT_AGGREGATOR_NAME: defaultAggregatorName,
          CROSS_ACCOUNT_CONFIG_ROLE: crossAccountConfigReadonlyRole ?? "",
    ...
    const schedulerFunctionDLQ = new sqs.Queue(this, "schedulerFunctionDLQ", {
      encryption: sqs.QueueEncryption.KMS_MANAGED,
    });
    this.schedulerFunction = new lambda.Function(
...

      {
        ...
        environment: {
          RULEBUNDLES_TABLE_NAME: props.ruleBundlesTable.tableName,
          AUTO_CONFIG_FUNCTION_NAME: this.autoConfigFunction.functionName,
          LOGLEVEL: "DEBUG",
          SOLUTION_ID: props.solutionId,
          VERSION: props.version,
        },
    ...
    const ruleSchedulerTriggerEventRule = new events.Rule(this, "TriggerRule", {
  ...
  private getEvaluationIntervalValue(): Duration {
    const configuredValue = this.node.tryGetContext("ruleResolutionInterval");
