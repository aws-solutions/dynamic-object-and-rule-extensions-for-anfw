...
import { BasicHttpError, BasicHttpResponse } from "src/HttpTypes";

/* eslint-disable */
describe('Basic http error tests', () => {
...
describe('Basic http response tests', () => {
    test('test basic http response with constructor', () => {
        expect(new BasicHttpResponse(200, 'test message', { header1: 'value1' })).toEqual(
            {
                body: 'test message',
                headers: {
                    header1: 'value1',
